 ...
 * 
 * Please refer to <a
 * href="http://api.mongodb.org/java/2.11.2/com/mongodb/MongoClientURI.html"
 * >MongoClientURI documentation</a> for the various options that can be passed
 * in via the URI.
 * 
